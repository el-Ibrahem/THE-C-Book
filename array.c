...
// a + i = ram : [ a[0] - a[1] - a[2] ... - a[i]] , i here represents the number of indicies
...
int main(){
    ...
    for (unsigned int i = 0;i < 10;i++) {
        ...
        // if the number is decimel : C rounds it down eg 51.14 --> 51 ASCII for '3'
    ...
    printf("%p", (void *)(&str[6])); 
    // print the the adress of index 6 , also meow (void *) simply change the pointer type from char * --> void *
